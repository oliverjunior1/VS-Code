...
while True:
    ...
    match option_country:
        case 1:
            option_food = int(input(f"Put 1 to feijoada, 2 to moqueca capixaba and 3 to pão de queijo: "))
            match option_food:
                case 1:
        ...
        case 2:
            option_food = int(input(f"Put 1 lasagna, 2 to risotto, 3 to Tiramisu, and 4 to exit: "))
            match option_food:
                case 1:
